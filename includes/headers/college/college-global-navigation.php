...
$global_nav = array(
	...
	'about' 	=> array(
		...
		'unit-menu' => array(
			array( 'label' => 'Link Title Here', 'url' => '#' ),
			array( 'label' => 'Link Title Here', 'url' => '#' ),
			array( 'label' => 'Link Title Here', 'url' => '#' ),
			array( 'label' => 'Link Title Here', 'url' => '#' ),
			array( 'label' => 'Link Title Here', 'url' => '#' ),
	...
	'extension' => array(
		...
		'sub-menu' => array(
			array(
				...
				'link' => 'http://extension.wsu.edu/about-extension/',
				'menu-items' => array(
					array( 'label' => 'Extension is for Everyone!', 'url' => 'http://extension.wsu.edu/about-extension/extension-is-for-everyone/' ),
					array( 'label' => 'Programs', 'url' => 'http://extension.wsu.edu/programs/' ),
					array( 'label' => 'Extension Publications', 'url' => 'http://extension.wsu.edu/learn/' ),
					array( 'label' => 'Impacts', 'url' => 'http://extension.wsu.edu/impact-reports/' ),
					array( 'label' => 'Order Extension apparel', 'url' => 'http://estoresbyzome.com/wsu_extension.php' ),
				)
			),
			array(
		...
		'action-links' => array(
			array( 'label' => 'Locations', 'url' => 'http://extension.wsu.edu/locations/' ),
			array( 'label' => 'Programs', 'url' => 'http://extension.wsu.edu/programs/' ),
			array( 'label' => 'Volunteers', 'url' => 'http://ext.wsu.edu/volunteers/logon.aspx' ),
		)
	),
	'alumni' 	=> array(
	...
	'fs' 		=> array(
		...
		'sub-menu' => array(
			array(
				...
				'link' => 'http://cahnrs.wsu.edu/fs/home/business-services/',
				'menu-items' => array(
					array( 'label' => 'Business Center', 'url' => 'http://cahnrs.wsu.edu/fs/home/business-services/business-centers/' ),
					array( 'label' => 'Extension Support', 'url' => 'http://cahnrs.wsu.edu/fs/home/business-services/extension-and-county-support/' ),
					array( 'label' => 'FS Quick Links', 'url' => 'http://cahnrs.wsu.edu/fs/quick-links/' ),
				)
			),
			array(
				'label' => 'Support Units',
				'link' => 'http://cahnrs.wsu.edu/fs/business-units/',
				'menu-items' => array(
			...
			array(
				...
				'link' => 'http://cahnrs.wsu.edu/fs/business-units/',
				'menu-items' => array(
					array( 'label' => 'Hire, Purchase, Travel', 'url' => 'http://cahnrs.wsu.edu/fs/quick-links/' ),
					array( 'label' => 'Prepare a Grant', 'url' => 'http://cahnrs.wsu.edu/fs/home/research-and-grant-unit/grant-preparation/proposal-development/' ),
					array( 'label' => 'Publish with Extension', 'url' => 'http://cahnrs.wsu.edu/communications/getting-published/' ),
					array( 'label' => 'Recognize a Colleague', 'url' => 'http://cahnrs.wsu.edu/fs/recognize-a-colleague/' ),
					array( 'label' => 'Report Research Project', 'url' => 'http://cahnrs.wsu.edu/fs/home/research-and-grant-unit/grant-preparation/reeport-instructions/' ),
				)
			),
		),
		'action-links' => array(
			array( 'label' => 'E-Form Login', 'url' => 'https://webapps.wsu.edu/ais/wsueforms' ),
			array( 'label' => 'Leave Reporting', 'url' => 'http://cahnrsforms.wsu.edu/leavereports/welcome.aspx' ),
			array( 'label' => 'WORQS', 'url' => 'https://worqs.wsu.edu/login.aspx?ReturnUrl=%2fDefault.aspx' ),
		)
	),
);?>
	...
	<nav class="college-global">
		...
		<?php foreach( $global_nav as $slug => $nav ):?>
			...
			<?php if ( ! empty( $nav['sub-menu'] ) ):?><ul class="drop-down-menu">
				...
				<li class="link-list">
					<span><?php echo $sub_menu_set['label'];?></span>
					<ul class="submenu">
						<?php foreach( $sub_menu_set['menu-items'] as $index => $sub_menu_item ):?>
						<li class="submenu-item">
							<a href="<?php echo $sub_menu_item['url'];?>"><?php echo $sub_menu_item['label'];?></a>
						</li>
						<?php endforeach;?>
					</ul>
				</li>
...
jQuery('body').on(
	'click',
	'#college-global-nav .college-global > ul > li > a',
	function( event ){
	}
)
</script>